...
_config_dict = dict(
    ...
    SOLVER=dict(
            CHECKPOINT_PERIOD=1462, # 1462 images
            LR_SCHEDULER=dict(
                MAX_ITER=17544, # divided by 10 for smaller dataset 12 epochs
                STEPS=(11696, 15595), # divided by 10 for smaller dataset 8 epochs and 10.6 epochs
            ),
            OPTIMIZER=dict(
